...
def train_catboost_model(*, enable_optuna: bool | None = None) -> dict[str, Any]:
    ...
    model.save(config.CATBOOST_MODEL_PATH)
    ...
    summary = {
        ...
        "latency": latency,
        "artifacts": {
            "model": str(config.CATBOOST_MODEL_PATH),
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Train CatBoost category classifier")
    ...
    summary = train_catboost_model(enable_optuna=use_optuna)
    print(
